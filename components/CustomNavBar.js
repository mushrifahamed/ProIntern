  ...
  return (
    ...
    >
      <View style={styles.customNavBar}>
        ...
        >
          <HomeIcon size={35} strokeWidth={1} />
          <Text
            style={[
        ...
        <TouchableOpacity
          onPress={() => handleNavigation("Applicants")}
          style={[
            styles.navItem,
            selectedTab === "Applicants" && styles.selectedTab,
          ]}
        >
          <ListIcon
            color={
              selectedTab === "Applicants" ? colors.primary : colors.primary
            }
            size={30}
            strokeWidth={1}
          />
          <Text
            style={[
              styles.customNavItem,
              selectedTab === "Applicants" && styles.selectedText,
            ]}
          >
            Applicants
          </Text>
        ...
        >
          <UserIcon size={30} strokeWidth={1} />
          <Text
            style={[
              styles.customNavItem,
        ...
        >
          <SettingsIcon
            color={selectedTab === "Settings" ? colors.primary : colors.primary}
            size={30}
          />
          <Text
            style={[
              styles.customNavItem,
              selectedTab === "Settings" && styles.selectedText,
            ]}
          >
            Settings
          </Text>
...
const styles = StyleSheet.create({
  ...
  iconContainer: {
    borderWidth: 2, // Adjust the thickness for a stroke-like effect
