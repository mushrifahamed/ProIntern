  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        onPress={() => handleCall("0764171391")}
      >
        <Ionicons name="call" size={24} color={colors.primary} />
        <Text style={styles.contactText}>076 417 1391</Text>
      </TouchableOpacity>

      <TouchableOpacity
        style={styles.contactItem}
        onPress={() => handleWhatsApp("0764171391")}
      >
      ...
      <TouchableOpacity
        style={styles.contactItem}
        onPress={() => handleEmail("prointernlk@gmail.com")}
      >
        <Ionicons name="mail" size={24} color={colors.primary} />
        <Text style={styles.contactText}>prointernlk@gmail.com</Text>
      </TouchableOpacity>
    </View>
  );
};
